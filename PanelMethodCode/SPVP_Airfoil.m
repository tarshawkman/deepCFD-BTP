...
flagAirfoil.XFoilCreate = 0;                                                % Create specified NACA airfoil in XFOIL
flagAirfoil.XFoilLoad   = 1;                                                % Load Selig-format airfoil from directory

% User-defined knowns
Vinf = 1;                                                                   % Freestream velocity [] (just leave this at 1)
AoA  = 0;                                                                   % Angle of attack [deg]
NACA = '0015';                                                              % NACA airfoil to load [####(#)]
